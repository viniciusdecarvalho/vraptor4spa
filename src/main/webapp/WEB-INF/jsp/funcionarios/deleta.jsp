<%@ include file="/WEB-INF/partial/_header.jsp" %>		
	...
	<div class="row">
	    <div class="col-lg-12">
            <form role="form" method="post" action="${linkTo[FuncionariosController].deleta(funcionario.id)}" >
	            ...
	            <div class="panel-body">
	                <input type="hidden" name="funcionario.id" value="${funcionario.id }"/>
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" class="form-control" name="funcionario.nome" value="${funcionario.nome}" autofocus disabled />
                   	 </div>
                    <div class="form-group">
                         <label>${t['funcionario.cpf'] }</label>
                         <input type="text" class="form-control" name="funcionario.cpf" value="${funcionario.cpf}" disabled />
                    </div>
                    <div class="form-group">
