<%@ include file="/WEB-INF/partial/_header.jsp" %>
	...
	<div class="row">
	    <div class="col-lg-12">
	        <h1 class="page-header">${empty fornecedor.id ? t['fornecedor.adiciona'] : t['fornecedor.edita']}</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	...
	<div class="row">
	    <div class="col-lg-12">
            <form role="form" method="post" action="${linkTo[FornecedoresController].salva}" >
	        <div class="panel panel-default">
	            <div class="panel-heading">
		            <button type="submit" class="btn btn-primary"><i class="fa fa-check"></i>${t['botao.confirma']}</button>
					<a href="${linkTo[FornecedoresController].lista }" class="btn btn-danger"><i class="fa fa-times-circle"></i>${t['botao.cancela']}</a>
	            </div>
	            <!-- /.panel-heading -->
	            <div class="panel-body">
	                <input type="hidden" name="fornecedor.id" value="${fornecedor.id }"/>
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" class="form-control" name="fornecedor.razaoSocial" placeholder="${t['fornecedor.razaoSocial'] }" value="${fornecedor.razaoSocial}" autofocus />
                   	</div>
                   	<div class="form-group">	                            
